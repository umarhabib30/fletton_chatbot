    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top" style="background: #1A202C !important">
                <a class="navbar-brand" href="{{ url('admin/dashboard') }}"><img src="{{ asset('assets/logo/FlettonsChat Logo Transparent.png') }}" alt="" style="width: 15%"></a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{ asset('assets/logo/logo.png') }}" alt="" class="user-avatar-md rounded-circle border-white"></a>
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fas fa-sign-in-alt mr-2"></i>Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link @if ($active == 'dashboard') active @endif"
                                    href="{{ url('admin/dashboard') }}"><i class="fas fa-tachometer-alt"></i>Dashboard
                                    <span class="badge badge-success">6</span></a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link @if ($active == 'credentials') active @endif" href="{{ url('admin/credentials') }}"><i class="fas fa-user-secret"></i>Credentials</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link collapsed @if ($active == 'templates') active @endif" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Templates</a>
                                <div id="submenu-5" class="submenu collapse" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ url('admin/templates/index') }}">View All</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link collapsed @if ($active == 'users') active @endif" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-users"></i>Users</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link collapsed @if ($active == 'messages') active @endif" href="{{ url('admin/send-template') }}" ><i class="fab fa-whatsapp"></i>Send Message</a>
                            </li>
